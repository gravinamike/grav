...
"""
Basic full-featured modular text editor to plug into other parts of the app.
Using code from

author: Mike Gravina, built off Peter Goldsborough's code originating from
...
class TextEdit(QtGui.QMainWindow):
    ...
    def initToolbar(self):
        ...
        self.commitAction = QtGui.QAction(QtGui.QIcon("icons/save.png"),"COMMIT CHANGES",self)
        self.commitAction.setStatusTip("Commit changes to database")
        self.commitAction.setShortcut("Ctrl+L")
        self.commitAction.triggered.connect(self.window.saveNotes)
        ...
        self.toolbar.addAction(self.commitAction)
    ...
    def initFormatbar(self):
        ...
        fontBox.setCurrentFont(QtGui.QFont('Arial', pointSize=12, weight=-1, italic=False))
        ...
        self.formatbar2 = self.addToolBar("Format (cont'd)")

        self.formatbar2.addAction(alignLeft)
        self.formatbar2.addAction(alignCenter)
        self.formatbar2.addAction(alignRight)
        self.formatbar2.addAction(alignJustify)

        self.formatbar2.addSeparator()

        self.formatbar2.addAction(indentAction)
        self.formatbar2.addAction(dedentAction)

        self.formatbar2.addSeparator()

        self.formatbar2.addAction(bulletAction)
        self.formatbar2.addAction(numberedAction)
    ...
    def initMenubar(self):
        ...
        file.addAction(self.commitAction)
